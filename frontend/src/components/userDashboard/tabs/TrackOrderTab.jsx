...
function TrackOrderTab() {
  ...
  const userOrders = [
    {
      ...
      trackingSteps: [
        ...
        },
        {
          status: "shipped",
          title: "Shipped",
          description: "Order has left our facility",
    ...
    },
    {
      ...
      trackingSteps: [
        ...
        },
        {
          status: "in_transit",
          title: "In Transit",
          description: "Package will be on the way",
          date: "Pending",
          completed: false,
        },
        {
  ...
  const handleTrackOrder = () => {
    ...
    if (order) {
      ...
      toast("Order not found. Please check your order ID and try again.");
    }
    setShowSuggestions(false);
  };
    ...
    <div className="max-w-4xl mx-auto p-6 bg-background">
      ...
      {!selectedOrder && (
        <div className="text-center py-12 bg-card border border-border rounded-lg">
          ...
          <p className="text-muted-foreground">
            Start typing your order ID above to see tracking information
          </p>
        </div>
      )}
    </div>
